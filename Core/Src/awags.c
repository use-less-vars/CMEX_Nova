...
//TODO: Timer, um die warte zeiten individuell zu setzen
...
void trigger_execution(void) 
{
    ...
    //start timer to wait the integration time
    // trigger ADC after half of the time??
    // after elapsed timer -> set_reset(true);
}
